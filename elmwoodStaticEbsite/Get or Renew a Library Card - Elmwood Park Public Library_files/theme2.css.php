...
.responsiveMenuTheme2{list-style:none;zoom:1;background:#efefef;margin:0;padding:0;font-family:"PT Sans Narrow","Arial Narrow",Arial,Helvetica,sans-serif;font-size: 18px;width: 100%;}
...
.responsiveMenuTheme2 a {color:#333333;padding:0px 15px;text-decoration:none;}
.responsiveMenuTheme2 span.separator{color:#333333;padding:0 0 0 15px;display:block;cursor:pointer; }
.responsiveMenuTheme2 a:hover, .responsiveMenuTheme2 li.active > a, .responsiveMenuTheme2 li > span.separator:hover{color:#333333;background-color: #d7d7d7}
...
.responsiveMenuTheme2 li li > a{display:block;background:#ffffff;position:relative;z-index:100;border-top:1px solid #d7d7d7;white-space:nowrap;}
...
.responsiveMenuTheme2 li li span.separator {display:block;background:#ffffff;position:relative;z-index:100;border-top:1px solid #d7d7d7;}
.responsiveMenuTheme2 li li li a{background:#ffffff;z-index:200;border-top:1px solid #d7d7d7;}
.responsiveMenuTheme2 li li.parent a{padding: 0 40px 0 15px;}

.toggleMenu{display:none;color:#333333;padding:10px 15px;background:#d7d7d7 url(../images/toggle-icon.png) no-repeat left center;height:40px;padding:0 0px 0 40px;line-height:40px;border-radius: 5px;font-family:"PT Sans Narrow","Arial Narrow",Arial,Helvetica,sans-serif;font-size: 18px;}
.toggleMenu span{padding-right:10px;}
.toggleMenu.active{border-radius: 5px 5px 0 0;}
.responsiveMenuTheme2.isMobile .active{display:block;}
.responsiveMenuTheme2.isMobile > li{float:none;border-top:1px solid #d7d7d7;}
...
.responsiveMenuTheme2 span.navHeader{color:#333333;padding:0 15px;display:block;}
.responsiveMenuTheme2 > li.parent > span.navHeader{padding: 0px 40px 0px 15px;}
.responsiveMenuTheme2 li li span.navHeader {display:block;background:#ffffff;position:relative;z-index:100;border-top:1px solid #d7d7d7;}
.responsiveMenuTheme2.isDesktop > li > a{border-left:1px solid #d7d7d7;border-bottom:none;}
.responsiveMenuTheme2.isDesktop li a, .responsiveMenuTheme2.isDesktop li span.separator, .responsiveMenuTheme2.isDesktop li span.navHeader{border-left:1px solid #d7d7d7;border-bottom:none;}
